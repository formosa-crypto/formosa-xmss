...
do split.
  ...
  - move=>?.
    have ?: to_uint sm_offset{1} = 2179 by apply H41.
  ...
  - admit. (* to_uint P5.[6] = to_uint ots_addr{1}.[4] *) 
  ...
  - move => H45 H46 H47 H48 H49 H50 H51 H52 H53 H54 resL resR H55 H56 *.
    do split.
      * smt(sub_k).
      * admit.
      * rewrite -H23.
