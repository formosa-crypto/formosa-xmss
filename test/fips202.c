...
static void keccak_squeezeblocks(unsigned char *h, unsigned long long nblocks, uint64_t *s,
                                 unsigned int r) {
    unsigned int i;
...
void shake128(unsigned char *out, unsigned long long outlen, const unsigned char *in,
...
void shake256(unsigned char *output, unsigned long long outlen, const unsigned char *in,
              unsigned long long inlen) {
    unsigned long long i;
    uint64_t s[25];
